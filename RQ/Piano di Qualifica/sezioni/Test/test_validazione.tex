...
\item Essere autenticato;
\item Trovarsi nella sezione apposita;
\item Impostare la foto da inserire;
\item Visualizzare il profilo dell’utente modificato.
\end{itemize}
 & \textit{Non Implementato}\\ \hline
...
\item Essere autenticato;
\item Trovarsi nella sezione apposita;
\item Premere il tasto di eliminazione;
...
\end{itemize} & \textit{Non Implementato}\\ \hline
\hypertarget{TVFD8.2}{TVFD8.2} & L’utente autenticato pro  intende modificare un questionario esistente. All’utente è richiesto di:
\begin{itemize}
