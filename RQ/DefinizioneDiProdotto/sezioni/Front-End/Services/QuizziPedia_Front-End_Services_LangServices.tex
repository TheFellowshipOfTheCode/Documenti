...
\begin{itemize}
	...
	\begin{itemize}
		...
		\end{itemize}
		\item \texttt{+} \texttt{getKeywords(lang: String): Object} \\Metodo che ritorna la lista di tutte le \textit{keywords\ped{G}} nella lingua richiesta.\\
		\textbf{Parametri}:
		\begin{itemize}
			\item \texttt{lang: String} \\ Parametro che indica la lingua delle \textit{keywords\ped{G}} da restituire.
		\end{itemize}
			\item \texttt{+} \texttt{getSLang(lang: String): Object} \\Metodo che ritorna l'abbreviazione della lingua passata (per utilizzarla nell'url).\\
			\textbf{Parametri}:
			\begin{itemize}
				\item \texttt{lang: String} \\ Parametro che indica la lingua.
			\end{itemize}
			\item \texttt{+} \texttt{getSupportedLang(): Object} \\Metodo che ritorna le lingue supportate dal sistema.
	\end{itemize}
\end{itemize}