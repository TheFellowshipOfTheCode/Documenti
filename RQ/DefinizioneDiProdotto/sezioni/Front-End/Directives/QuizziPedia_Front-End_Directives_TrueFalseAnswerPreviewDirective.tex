	\paragraph{QuizziPedia::Front-End::Directives\\::TrueFalseAnswerPreviewDirective}
		...
		\begin{itemize}
			\item \textbf{Descrizione}: \textit{directive\ped{G}} che permette di visualizzare una parte del testo di una domanda vero/falso;
