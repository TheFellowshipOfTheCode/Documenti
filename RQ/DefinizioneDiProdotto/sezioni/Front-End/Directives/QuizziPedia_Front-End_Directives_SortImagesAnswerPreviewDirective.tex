	\paragraph{QuizziPedia::Front-End::Directives\\::SortImagesAnswerPreviewDirective}
		...
		\begin{itemize}
			\item \textbf{Descrizione}: \textit{directive\ped{G}} che permette di visualizzare una parte del testo di una domanda di ordinamento immagini;
