...
\begin{itemize}
	...
	\item \textbf{Metodi}:
	\begin{itemize}
		\item \texttt{+} \texttt{EditorQMLController(\$scope: \$scope, QuestionItemModel: \\QuestionItemModel, \$mdDialog: \$mdDialog, QuestionService: \\QuestionService, \$routeParams: \$routeParams, ParserQML: ParserQML, \$location: \$location, \$routeParams: \$routeParams, \$rootScope: \$rootScope)} \\ 
		...
		\begin{itemize}
			...
			Parametro contenente il riferimento all'oggetto globale \$rootScope creato da \textit{Angular\ped{G}}. Viene utilizzato per rendere accessibile a tutti i \textit{controller\ped{G}} e a tutte le \textit{view\ped{G}} l'oggetto \texttt{UserDetailsModel}.
		\end{itemize}
