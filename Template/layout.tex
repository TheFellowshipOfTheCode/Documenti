...
\setcounter{secnumdepth}{7}		% mostra nel documento fino al livello 4 (1.2.3.4)
\setcounter{tocdepth}{7}			% mostra nell'indice fino al livello 4 (1.2.3.4)
...
\newcommand\subsubsubparagraph{%
  \@startsection{subsubsubparagraph}    % counter
    ...
    {0.75em}                           % afterskip
    {\normalfont\normalsize\bfseries}}
\newcommand\l@subsubsubparagraph{\@dottedtocline{6}{10em}{5em}}
