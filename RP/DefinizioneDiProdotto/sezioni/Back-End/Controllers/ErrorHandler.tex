...
\begin{itemize}
	...
	\begin{itemize}
		...
		Classe che gestisce le richieste relative alla gestione di un questionario. Componente ConcreteHandler del design pattern \textit{Chain of responsibility\ped{G}}.
		\item IN \texttt{QuestionRouter}\\
		Classe che gestisce le richieste relative alla gestione di una domanda. Componente ConcreteHandler del design pattern \textit{Chain of responsibility\ped{G}}.
		\item IN \texttt{UserRouter}\\
		Classe che gestisce le richieste relative alla gestione di un utente. Componente ConcreteHandler del design pattern \textit{Chain of responsibility\ped{G}}. Utilizza il modulo \textit{Passport\ped{G}}.
