...
\\
\textbf{Descrizione}:
\label{Procedura di visualizzazione del riepologo di un particolare questionario svolto}
\begin{figure}[ht]
	\centering
...
\FloatBarrier
\item \textbf{Fallimento}
\label{Fallimento della procedura di visualizzazione del riepologo di un particolare questionario svolto}
\begin{figure}[ht]
	\centering
