...
\begin{itemize}
\item \textbf{Successo}
Questo scenario rappresenta l'azione di \textit{logout} da parte di un utente precedentemente autenticato nel sistema. La \textit{logout} dell'utente viene effettuata tramite \textit{Passport\ped{G}}.
