...
\begin{itemize}
	\item \texttt{express.compress()}: \textit{middleware\ped{G}} per comprimere con il formato \texttt{gzip} le comunicazioni;
	...
	\item \texttt{express.urlencoded()}: \textit{middleware\ped{G}} che estrae dalla richiesta i parametri di tipo \\ \texttt{www-form-encoded}, questi possono essere inviati ad esempio con una richiesta POST;
