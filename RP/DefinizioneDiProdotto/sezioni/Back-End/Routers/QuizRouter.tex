...
\FloatBarrier
	\begin{itemize}
		...
		Contiene diverse \textit{route\ped{G}} che vengono configurate all'avvio del server. Quest'ultime ricevono le richieste del client e passano il controllo al \textit{ConcreteHandler\ped{G}} successivo. \\
		\textbf{Parametri}:
		\begin{itemize}
