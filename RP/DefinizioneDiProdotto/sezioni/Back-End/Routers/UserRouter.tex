...
Componente ConcreteHandler del design pattern \textit{Chain of responsibility\ped{G}}. Utilizza il modulo \textit{Passport\ped{G}}.
		\item \textbf{Utilizzo}: viene utilizzata per chiamare il controller che si occupa di gestire le \textit{API\ped{G}} relative alla registrazione, alla gestione della sessione e alla cronologia dei questionari di un utente;
