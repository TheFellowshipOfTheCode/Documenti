	\paragraph{QuizziPedia::Front-End::Directives\\::MultipleChoiceAnswerPreviewDirective}
		...
		\begin{itemize}
			\item \textbf{Descrizione}: \textit{directive\ped{G}} che permette di visualizzare una parte del testo di una domanda a risposta multipla;
