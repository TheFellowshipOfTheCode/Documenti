	\paragraph[QuizziPedia::Front-End::Directives\\::MultipleChoiceAnswerDirective]{QuizziPedia::Front-End::Directives::MultipleChoiceAnswerDirective}
		...
		\begin{itemize}
			\item \textbf{Descrizione}: rappresenta il componente grafico che permette all'utente di visualizzare la domanda a risposta multipla. Viene visualizzato dinamicamente all'interno delle views \texttt{TrainingView} e \texttt{FillingQuestionnaireView} mediante il \textit{controller\ped{G}} \texttt{QuestionsController};
