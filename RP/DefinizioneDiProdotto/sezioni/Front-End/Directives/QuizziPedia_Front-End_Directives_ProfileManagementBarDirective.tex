...
\begin{itemize}
	...
	\begin{itemize}
		\item \texttt{+ profileManagementButton: String} \\ Attributo che viene utilizzato per visualizzare la giusta traduzione della \textit{label\ped{G}} per il bottone di link alla gestione del profilo utente, in italiano o in inglese.
	\end{itemize}
\end{itemize}