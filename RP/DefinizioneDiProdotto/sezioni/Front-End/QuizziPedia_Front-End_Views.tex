...
\begin{itemize}
	...
	\begin{itemize}
		\item \texttt{+ question: Object} \\ Oggetto contenente gli attributi per la creazione della domanda:
		\begin{itemize}
			\item \texttt{url}: attributo di tipo \texttt{String} che contiene l'\textit{URL\peg{G}} associato all'immagine;
			\item \texttt{answer}: array contenente oggetti che rappresentano le risposte. Ogni oggetto risposta contiene:
			\begin{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \textit{IN} \texttt{TopicKeywordsDirective}: directive contenente i componenti grafici per aggiungere keywords durante la creazione di un questionario;
