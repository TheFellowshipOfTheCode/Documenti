...
\begin{itemize}
	\begin{figure} [ht]
		...
		\caption{QuizziPedia::Front-End::Controllers::LoginView}
	...
	\begin{itemize}
		...
		\item \texttt{+ bottonLang: String} \\ Attributo che viene utilizzato per visualizzare la giusta traduzione della \textit{label\ped{G}} per il bottone di autenticazione, in italiano o in inglese;
		\item \texttt{+ recuperaBotton: String} \\ Attributo che viene utilizzato per visualizzare la giusta traduzione della \textit{label\ped{G}} per il bottone di link al recupero della password, in italiano o in inglese;
