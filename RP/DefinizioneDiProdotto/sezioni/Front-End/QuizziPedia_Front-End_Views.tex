...
\item \textbf{Attributi}:
	\begin{itemize}
		...
		\begin{itemize}
			\item \texttt{questionText}: attributo di tipo \texttt{String} che contiene il testo della domanda;
			\item \texttt{image}: attributo di tipo \texttt{String} che contiene l'\textit{URL\ped{G}} dell'immagine associata al testo della domanda;
			\item \texttt{isItRight}: attributo di tipo \texttt{Boolean} che indica se la domanda è giusta o sbagliata.			
		\end{itemize}
		\item \texttt{+ titleLang: String} \\ Attributo che viene utilizzato per visualizzare la giusta traduzione del titolo della pagina, in italiano o in inglese;
		\item \texttt{+ buttonConfirmLang: String} \\ Attributo che viene utilizzato per visualizzare la giusta traduzione della \textit{label\ped{G}} per il bottone di conferma, in italiano o in inglese;
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\begin{itemize}
				\item \texttt{textAnswer}: attributo di tipo \texttt{String} che contiene il testo della risposta;
				\item \texttt{urlAnswer}: attributo di tipo \texttt{String} che contiene l'\textit{URL\ped{G}} dell'immagine associata alla risposta;
				\item \texttt{isItRight}: attributo di tipo \texttt{Boolean} che indica se la domanda è giusta o sbagliata.
			\end{itemize}			
		\end{itemize}
		\item \texttt{+ titleLang: String} \\ Attributo che viene utilizzato per visualizzare la giusta traduzione del titolo della pagina, in italiano o in inglese;
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \textit{IN} \texttt{KeywordsDirective}: directive contenente i componenti grafici per aggiungere keywords durante la creazione di un questionario;
...
\begin{itemize}
	...
	\item \textbf{Relazioni con altre classi}:
	\begin{itemize}
		\item \textit{IN} \texttt{ResultsQuestionnaireModelView}: classe di tipo modelview la cui istanzazione è contenuta all'interno della variabile di ambiente \$scope di \texttt{Angular.js}. All'interno di essa sono presenti le variabili e i metodi necessari per il \textit{Two-Way Data-Binding\ped{G}} tra la view \texttt{ResultsQuestionnarieView} e il controller \texttt{ResultsQuestionnarieController}; 
		\item \textit{IN} \texttt{LangModel}: rappresenta il modello delle informazioni per la giusta traduzione dell'applicazione.
	\end{itemize}
	\item \textbf{Attributi}:
	\begin{itemize}
