...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \textit{IN} \texttt{QuestionnaireModel}: \textit{model\ped{G}} relativo ai questionari;
		\item \textit{IN} \texttt{QuestionsService}: questa classe permette di ottenere le domande dal back-end.
	\end{itemize}
