...
\begin{figure} [ht]
	\centering
	\includegraphics[scale=0.35]{UML/Classi/Front-End/QuizziPedia_Front-end_Controller_TrueFalseQuestionsController.png}
...
\begin{itemize}
	...
	\item \textbf{Metodi}:
	\begin{itemize}
		\item \texttt{+} \texttt{TrueFalseQuestionsController(\$scope: \$scope, QuestionItemModel: Quest-\\ionItemModel, \$mdDialog: \$mdDialog, QuestionService: QuestionService,\\ Upload: Upload, \$timeout: \$timeout, \$routeParams: \$routeParams)} \\ 
