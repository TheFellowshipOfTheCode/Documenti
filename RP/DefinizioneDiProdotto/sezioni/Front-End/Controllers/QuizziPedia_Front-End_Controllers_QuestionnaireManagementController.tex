...
\begin{itemize}
	...
	\begin{itemize}
		...
		\end{itemize}
		\item \texttt{+} \texttt{getUserQuestionnaire(username: String) Array<QuestionnaireModel>} \\Metodo che ritorna tutti i questionari creati da un utente in un array di \texttt{QuestionnaireModel}. \\
		\textbf{Parametri}:
		\begin{itemize}
