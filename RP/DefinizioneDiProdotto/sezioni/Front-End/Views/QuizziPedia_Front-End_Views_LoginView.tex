...
\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{IN \texttt{LoginModelView}}: classe di tipo modelview la cui istanziazione è contenuta all'interno della variabile di ambiente \$scope di \textit{Angular\ped{G}}. All'interno di essa sono presenti le variabili e i metodi necessari per il \textit{Two-Way Data-Binding\ped{G}} tra la view \texttt{LoginView} e il \textit{controller\ped{G}} \texttt{LoginController};
