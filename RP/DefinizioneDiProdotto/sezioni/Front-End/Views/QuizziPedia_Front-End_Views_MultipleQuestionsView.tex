...
\begin{itemize}
	...
	\begin{itemize}
		\item \texttt{+ titleLangMultipl: String} \\ Attributo che viene utilizzato per visualizzare la giusta traduzione del titolo della pagina, in italiano o in inglese;
