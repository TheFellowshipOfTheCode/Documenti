...
\label{QuizziPedia::Front-End::View::UserView}
\begin{figure} [ht]
	\centering
...
\begin{itemize}
	\item \textbf{Descrizione}: \textit{view\ped{G}} contenente le direttive dei dati personali dell'utente, delle sue statistiche relative ai questionari e agli allenamenti effettuati e dei questionari a cui è iscritto;
	...
	\begin{itemize}
		...
		\end{itemize}
		Al verificarsi dell'evento click su un item della lista l'utente verrà indirizzato alla \textit{view\ped{G}} per la compilazione del questionario selezionato;
