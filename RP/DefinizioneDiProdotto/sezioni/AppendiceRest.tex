...
\begin{itemize}
	...
	\item \texttt{112 Username non disponibile:} l 'username è  gia stato utilizzato, prego inserire un nuovo username;
	...
	\item \texttt{1000 Dati non validi:} i dati relativi al contenuto del questionario non valdi;
