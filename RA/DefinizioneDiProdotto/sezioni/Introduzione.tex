...
\begin{itemize}
	...
	\item \textbf{Documentazione del \textit{framework\ped{G}} ace.js}: \\
	...
	\item \textbf{Documentazione di \textit{AngularCSS\ped{G}}} per instradare ad ogni \textit{view\ped{G}} il giusto \textit{CSS\ped{G}}: \\
		\url{https://github.com/castillo-io/angular-css}
	\item \textbf{Documentazione di \textit{AngularUI\ped{G}}} per il layout di alcuni parti dell'applicazione: \\
		\url{https://angular-ui.github.io/bootstrap/}
	\item \textbf{Documentazione di \textit{Drag and Drop for AngularJS\ped{G}}} per la realizzazione delle domande: \\
		\url{http://codef0rmer.github.io/angular-dragdrop/#!/}
	\item \textbf{Documentazione di \textit{Angular-number-picker\ped{G}}} per la realizzazione di alcuni elementi grafici dell'applicazione: \\
		\url{https://github.com/leftstick/angular-number-picker}
	\item \textbf{Documentazione dei \textit{ServiceWorker\ped{G}}} per la realizzazione della parte offline dell'applicazione: \\
