	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \textbf{IN} \texttt{ChangeLangDirective}: \textit{directive\ped{G}} che mostra i bottoni che permettono di cambiare la lingua utilizzata all'interno dell'applicazione;
