\paragraph{QuizziPedia::Front-End::Models::QuestionnaireModel}
		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				Metodo \textit{setter\ped{G}} per le keywords del questionario.\\
				\textbf{Parametri}:
				\begin{itemize}
				...
				Metodo \textit{setter\ped{G}} per l'argomento del questionario.\\
				\textbf{Parametri}:
				\begin{itemize}
				...
				Metodo \textit{setter\ped{G}} per il voto del questionario.\\
				\textbf{Parametri}:
				\begin{itemize}
					\item {mark: Number}\\
				...
				Metodo \textit{getter\ped{G}} che restituisce il campo dati \texttt{argument};
				
				\item \texttt{+ getMark(): Number} \\
				Metodo \textit{getter\ped{G}} che restituisce il campo dati \texttt{mark};
