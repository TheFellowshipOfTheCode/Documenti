...
\begin{itemize}
  \item \textit{Interni}: utilizzo interno al \textit{team\ped{G}};
...
Per la stesura dell'intera documentazione è stato scelto di utilizzare \textit{\LaTeX\ped{G}}.
...
\textit{team\ped{G}} che ha portato all'accettazione dello sviluppo del progetto scelto. Questo
documento è utilizzato internamente dal \textit{team\ped{G}} e la lista di distribuzione comprende solo i committenti.
\paragraph{\NdP}
L'intento del suddetto documento è riportare tutte le convenzioni, strumenti e
norme che il \textit{team\ped{G}} dovrà adottare durante tutto lo sviluppo del progetto. Questo
documento è utilizzato internamente al \textit{team\ped{G}} e la lista di distribuzione comprende solo i committenti.
\paragraph{\PdP}
L'intento del suddetto documento è descrivere come il \textit{team\ped{G}} gestisce le risorse
...
e proponenti.
\paragraph{\PdQ}
L'intento del suddetto documento è descrivere il modo in cui l'intero \textit{team\ped{G}} punta
...
\paragraph{Formati}
\begin{itemize}
   \item \textbf{Date}: le date presenti nei documenti devono seguire lo standard \textit{ISO\ped{G} 8601:2004\ped{G}}:
   \begin{center}
     YYYY-MM-DD
   \end{center}
   dove:
   ...
   \end{itemize}
   \item \textbf{Ore}: le ore presenti nei documenti devono seguire lo standard \textit{ISOG\ped{G} 8601:2004\ped{G}}
   ...
   dovrà utilizzare il comando \textit{\LaTeX\ped{G}}   \verb|\documento{Nome del documento}|
   garantendo in questo modo la corretta sintassi;
   \item \textbf{Nome del gruppo}: per riferirsi al nome del gruppo si dovrà
   utilizzare il comando \textit{\LaTeX\ped{G}} \verb|\gruppo| garantendo in questo modo la corretta sintassi;
   \item \textbf{Nome del progetto}: per riferirsi al nome del progetto si dovrà
   utilizzare il comando \textit{\LaTeX\ped{G}} \verb|\progetto| garantendo in questo modo la corretta sintassi;
   \item \textbf{Link sito del gruppo}: per riferirsi al link del sito del gruppo si dovrà
   utilizzare il comando \textit{\LaTeX\ped{G}} \verb|\gruppoLink| garantendo in questo modo la corretta sintassi;
   \item \textbf{Email del gruppo}: per riferirsi all'indirizzo email del gruppo si dovrà
   utilizzare il comando \textit{\LaTeX\ped{G}} \verb|\email| garantendo in questo modo la corretta sintassi;
   \item \textbf{Nome del proponente}: per riferirsi al nome del proponente, ovvero \proponente, si dovrà
   utilizzare il comando \textit{\LaTeX\ped{G}}  \verb|\proponente| garantendo in questo modo la corretta
   sintassi.
      \end{itemize}
...
ruolo del \textit{team\ped{G}}, mentre verrà utilizzata la sintassi \textit{@Destinatario} per
...
impiegata:
\begin{itemize}
  \item \textbf{\textit{Walkthrough\ped{G}}}: questa tecnica di analisi statica consiste nella
  ...
  esperienza dei membri del \textit{team\ped{G}}. Questa tecnica è utilizzata dai \textit{Verificatori}
  ...
  \item \textbf{\textit{Inspection\ped{G}}}: questa tecnica di analisi statica consiste in una
