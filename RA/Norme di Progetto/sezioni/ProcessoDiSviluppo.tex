...
\subsubparagraph{Notazioni per il Front-End}

\subsubparagraph{Notazioni derivate da AngularJS}
\subsubparagraph{Directive}
...
\subsubparagraph{Controller}
Le funzioni che un controller definisce nell’oggetto \$scope sono state modellate come metodi pubblici del controller stesso.

\subsubparagraph{Promise e \$q}
...
\subsubparagraph{Notazioni per il Back-End}
\subsubparagraph{Express}
...
\subsubparagraph{MongoDB e Mongoose}
...
\subparagraph{Struttura dell'intestazione del file}
