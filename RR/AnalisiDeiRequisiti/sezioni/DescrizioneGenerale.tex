...
Il prodotto dovrà essere utilizzabile su un qualsiasi \textit{browser\ped{G}} compatibile con la tecnologia \textit{HTML5\ped{G}}, \textit{CSS3\ped{G}} e \textit{JavaScript\ped{G}} sia da desktop che da mobile, senza alcuna limitazione sul sistema operativo.
