...
\subsubsection{Caso d'uso UC5.1.2: Inserimento nuovo cognome utente}
...
\subsubsection{Caso d'uso UC5.1.3: Conferma modifiche nome e cognome utente}
...
\subsubsection{Caso d'uso UC5.2.1: Inserimento nuova e-mail}
...
\subsubsection{Caso d'uso UC5.2.2: Conferma modifiche e-mail}
...
\subsubsection{Caso d'uso UC5.3.1: Inserimento vecchia password}
...
\subsubsection{Caso d'uso UC5.3.2: Inserimento nuova password}
...
\subsubsection{Caso d'uso UC5.3.3: Conferma modifica password}
...
\begin{figure}[h]
	...
	\caption{UC5.4: Eliminazione account}
\end{figure}
...
\subsubsection{Caso d'uso UC5.4.1: Conferma eliminazione account}
