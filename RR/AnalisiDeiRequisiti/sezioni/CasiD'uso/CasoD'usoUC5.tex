...
\subsubsection{Caso d'uso UC5.1.3: Visualizzazione errore inserimento username}
\begin{itemize}
	\item \textbf{Attori}: utente autenticato, utente autenticato pro;
...
\subsubsection{Caso d'uso UC5.1.3: Visualizzazione errore inserimento foto/immagine}
\begin{itemize}
	\item \textbf{Attori}: utente autenticato, utente autenticato pro;
...
\subsubsection{Caso d'uso UC5.6.4: Visualizzazione errore inserimento password}
\begin{itemize}
	\item \textbf{Attori}: utente autenticato, utente autenticato pro;
