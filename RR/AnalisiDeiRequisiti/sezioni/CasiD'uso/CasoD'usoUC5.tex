...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
		...
		\end{enumerate}
	\item \textbf{Estensioni}: l'attore visualizza un messaggio d'errore (UC5.1.3);
...
\begin{itemize}
	...
	\end{enumerate}
	\item \textbf{Estensioni}: l'attore visualizza un messaggio d'errore (UC5.2.3);
	\item \textbf{Scenari alternativi}: l'attore annulla le modifiche e il sistema lo riporta alla schermata di gestione del profilo utente.
\end{itemize}
...
\begin{itemize}
	...
	\end{enumerate}
	\item \textbf{Estensioni}: l'attore visualizza un messaggio d'errore (UC5.3.3);
	\item \textbf{Scenari alternativi}: l'attore annulla le modifiche e il sistema lo riporta alla schermata di gestione del profilo utente.
\end{itemize}
...
\begin{itemize}
	...
	\end{enumerate}
	\item \textbf{Estensioni}: l'attore visualizza un messaggio d'errore (UC5.4.3);
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
		...
		\end{enumerate}
		\item \textbf{Estensioni}: l'attore visualizza un messaggio d'errore (UC5.5.3);
	\item \textbf{Scenari alternativi}: l'attore annulla le modifiche e il sistema lo riporta alla schermata di gestione del profilo utente.
\end{itemize}
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item L'attore può inserire la conferma della nuova password (UC5.6.3);
		\item L'attore può confermare la modifica della password (UC5.6.4).
	\end{enumerate}
	\item \textbf{Estensioni}: l'attore visualizza un messaggio d'errore (UC5.6.5);
	\item \textbf{Scenari alternativi}: l'attore annulla le modifiche e il sistema lo riporta alla schermata di gestione del profilo utente.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}: l'utente può confermare l'eliminazione del proprio account e dei relativi dati personali (UC5.8.1);
