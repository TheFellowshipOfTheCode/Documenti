...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item L'attore può confermare l'inserimento della nuova foto/immagine (UC5.3.2).
	\end{enumerate}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
		\begin{enumerate}
			...
			\item L'attore può confermare le modifiche al proprio indirizzo di posta elettronica (UC5.4.2).
		\end{enumerate}
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item L'attore può confermare la modifica della password (UC5.5.4).
	\end{enumerate}
	\item \textbf{Estensioni}: l'attore visualizza un messaggio d'errore (UC5.5.5);
	\item \textbf{Scenari alternativi}: l'attore annulla le modifiche e il sistema lo riporta alla schermata di gestione del profilo utente.
\end{itemize}
...
\subsubsection{Caso d'uso UC5.8.2: Conferma cambio tipologia account}
