...
\begin{itemize}
	...
	\item \textbf{Precondizione}: l'utente accede al sito \textit{web\ped{G}} mediante ad un \textit{browser\ped{G}} supportato dal sistema. Seleziona tra le scelte possibili l'opzione "Gestione questionari" nelle opzioni possibili del caso d'uso precedente;
...
\end{itemize}
	...
	\begin{itemize}
	 ...
	 \end{itemize}
		 ...
		 \subsubsection{Caso d'uso UC9.3.2: Elimina domanda}
		 \label{UC9.3.2}
		 \begin{figure}[h]
		 	\centering
