...
\item L'attore può scegliere di andare alla pagina di gestione dei questionari (UC11.3);
...
\item\textbf{Precondizione}: l'attore si trova nella propria pagine utente e ha compilato almeno un questionario;
\item\textbf{Postcondizione}: il sistema visualizza la cronologia dei questionari;
\item\textbf{Scenario principale}: 
\begin{enumerate}
\item L'attore può visualizzare le statistiche di un questionario (UC11.4.1).
\end{enumerate}
\end{itemize}
...
\item\textbf{Precondizione}: l'attore si trova nella propria pagine utente e ha richiesto l'abilitazione ad un questionario e il proprietario l'ha accettata;
\item\textbf{Postcondizione}: il sistema ha mostrato all'attore tutti i questionari a cui è stato abilitato;
\item\textbf{Scenario principale}:
\begin{enumerate}
\item L'attore può seleziona un questionario abilitato (UC11.5.1).
\end{enumerate} 
\end{itemize}
