...
\subsubsection{UC8.1: Creazione nuova domanda}
	\begin{center}
		\includegraphics[scale=0.8,keepaspectratio]{UML/UC8.1.png}
	\end{center}
	\begin{itemize}
		\item
	...
	\begin{center}
		\includegraphics[scale=0.5]{UML/UC8.2.png}
	\end{center}
	\begin{itemize}
		\item
			\textbf{Attori}: utente autenticato, utente autenticato pro;
	...
	\end{itemize}
	\subsubsection{UC8.2.1: Selezione opzione modifica domanda}
	\begin{itemize}
		\item
			\textbf{Attori}: utente autenticato, utente autenticato pro;
		\item
	...
	\begin{itemize}
		...
		\item
			\textbf{Post-condizione}: il sistema ha ricevuto i dati per la registrazione.
	\end{itemize}		
	\subsubsection{UC8.2.4: Visualizzazione errore modifica}
	\begin{itemize}
		\item
			\textbf{Attori}: utente autenticato, utente autenticato pro;
		\item
	...
	\begin{center}
		\includegraphics[scale=0.5]{UML/UC8.3.png}
	\end{center}
	\begin{itemize}
		\item
			\textbf{Attori}: utente autenticato, utente autenticato pro;
	...
	\end{itemize}
	\subsubsection{UC8.3.1: Selezione opzione eliminazione domanda}
	\begin{itemize}
		\item
			\textbf{Attori}: utente autenticato, utente autenticato pro;
		\item
