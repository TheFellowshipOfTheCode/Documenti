\subsubsection{Caso d'uso UC8.1.3.3: Creazione esercizio a riempimento di spazi vuoti}
	\label{UC8.1.3.3}
	\begin{figure}[h]
		\centering
	...
	\begin{itemize}
		...
		\item
			\textbf{Precondizione}: l'attore ha selezionato la funzionalità di creazione di un esercizio a riempimento di spazi vuoti;
		\item
