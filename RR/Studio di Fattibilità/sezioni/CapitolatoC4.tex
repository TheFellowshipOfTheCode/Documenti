...
\begin{itemize}
	\item \textbf{Node.js\ped{G}}: è un framework event-driven per il motore \textit{Javascript\ped{G}} sviluppato da Google. Si tratta quindi di un framework relativo all'utilizzo server-side di Javascript; 
	...
	\item \textbf{React.js\ped{G}}: è una libreria scritta in Javascript open-source sviluppata da Facebook che consente di creare interfacce utente complesse tramite la loro suddivisione in componenti; 
