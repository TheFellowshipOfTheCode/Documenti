...
L'obiettivo del progetto è di implementare un modello di database NoSQL di tipo Key-value utilizzando il \textit{modello ad attori\ped{G}}.
...
L'implementazione del suddetto sistema ad attori deve prendere il nome di \textbf{ACTORDB}. In particolare, per l'implementazione degli attori viene richiesto l'utilizzo della libreria \textit{Akka\ped{G}}.
Il linguaggio da utilizzare può essere scelto fra \textbf{Scala\ped{G}} o \textbf{Java\ped{G}}. 
