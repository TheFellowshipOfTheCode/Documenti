...
\begin{itemize}
\item \textbf{Capitolato d'appalto C1:} Actorbase: a \textit{NoSQL\ped{G}} DB based on the Actor model
...
\item \textbf{Capitolato d'appalto C4:} MaaS: \textit{MongoDB\ped{G}} as an admin Service
