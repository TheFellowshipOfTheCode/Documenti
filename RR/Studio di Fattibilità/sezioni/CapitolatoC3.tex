...
\begin{itemize}
\item \textbf{Amazon Web Services\ped{G}} e \textbf{Database NoSQL\ped{G}};
\item \textbf{Java\ped{G}} o \textbf{Scala\ped{G}}: come linguaggio di programmazione;
\item \textbf{Play Framework\ped{G}}: come piattaforma di sviluppo;
\item \textbf{HTML5\ped{G}}, \textbf{CSS3\ped{G}} e \textbf{Javascript\ped{G}}: per la parte di visualizzazione e comportamentale.
\end{itemize}
