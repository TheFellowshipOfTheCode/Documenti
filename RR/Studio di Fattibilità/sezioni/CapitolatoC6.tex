...
Il progetto prevede che l'applicazione sfrutti appieno le potenzialità offerte dal motore di sintesi vocale opensource \textit{Flexible and Adaptive Text To Speech\ped{G}}, che espone molteplici funzionalità reperibili mediante interfaccia \textit{HTTP\ped{G}}. Non vengono invece imposti vincoli tecnologici su progettazione e implementazione dell'applicazione.
...
\item Nessuna competenza del \textit{team\ped{G}} sulla sintesi vocale;
\item Utilizzo di \textit{framework\ped{G}} sconosciuti.
\end{itemize}

\subsection{Valutazione Finale}
Per quanto interessante e innovativo possa essere la sintesi vocale, il \textit{team\ped{G}} ritiene che le scarse competenze sull'argomento possano essere un problema sulla realizzazione di questo capitolato. Inoltre il gruppo ritiene che lo studio del motore di sintesi FA-TTS non dia delle competenze tecniche spendibili in un futuro ambito lavorativo d'interesse.
