...
\begin{itemize} 
	...
	\item 
	\textbf{Mozilla Firefox}: è un web browser opensource multipiattaforma prodotto da Mozilla Foundation. È disponibile per sistemi operativi Windows, Linux, Mac OS X, Android e Firefox OS. 
\end{itemize}
