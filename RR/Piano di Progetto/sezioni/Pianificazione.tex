...
\begin{itemize}
	...
	Le attività di questo tipo vengono rappresentate all'interno del \textit{diagramma di Gantt\ped{G}} con il colore \textbf{rosso};
	...
	Le attività di questo tipo vengono rappresentate all'interno del \textit{diagramma di Gantt\ped{G}} con il colore \textbf{blu}.
\end{itemize}
...
\begin{itemize}
		...
		\item \textit{\G}: scritto in maniera incrementale dai redattori dei diversi documenti. Contiene la spiegazione di alcuni termini utilizzati nei vari documenti, al fine di eliminare ogni possibile ambiguità di significato;
