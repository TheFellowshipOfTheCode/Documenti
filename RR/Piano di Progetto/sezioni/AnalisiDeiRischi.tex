...
\section{Analisi dei rischi}
	...
	\subsection{A livello del personale}
		...
		\begin{itemize}
			...
			\item \textbf{Probabilità di occorrenza}: bassa;
			\item \textbf{Grado di pericolosità}: alto;
			\item \textbf{Riconoscimento}: la comunicazione costante con il \Res può far sì che quest'ultimo monitori ogni tipo di problematica sul nascere;  
		...
		\begin{itemize}
			...
			\item \textbf{Grado di pericolosità}: alto;
			\item \textbf{Riconoscimento}: quando nasce la necessità di utilizzare una nuova tecnologia, questa deve essere riferita al \Res per far si che la integri nelle armonie di sviluppo del progetto e del gruppo; 
			\item \textbf{Trattamento}: ogni  membro del gruppo si impegna a studiare il materiale necessario per l'utilizzo di tecnologie e strumenti richiesti durante lo svolgimento del progetto. Nel caso in cui questo non fosse sufficiente il \Res dovrà preparare un piano di studi per sopperire ogni tipo di lacuna;	
			\item \textbf{Attuazione nel periodo}:
			\begin{itemize}
	...
	\subsection{A livello organizzativo}
		...
		\begin{itemize}
			...
			\item \textbf{Attuazione nel periodo}:
			\begin{itemize}
				\item \textbf{Analisi dei requisiti}: il rischio non è ancora valutabile.
			\end{itemize}
		\end{itemize}
	...
	\subsection{A livello dei requisiti}
		...
		\begin{itemize}
			\item \textbf{Descrizione}: è possibile che alcuni requisiti individuati dal capitolato vengano interpretati in modo erroneo o in maniera incompleta da parte degli \textit{\Anas} rispetto alle aspettative del proponente. \'E inoltre possibile che alcuni requisiti ;
			\item \textbf{Probabilità di occorrenza}: media;
			\item \textbf{Grado di pericolosità}: alto;
	...
	\subsection{A livello di valutazione dei costi}
		...
		\begin{itemize} 
			...
			\item \textbf{Probabilità di occorrenza}: media;
			\item \textbf{Grado di pericolosità}: medio;
			\item \textbf{Riconoscimento}: quando un'attività occupa più tempo di quello previsto significa che è stata sottostimata. Quando invece ne occupa considerevolmente meno significa che è stata sovrastimata. \'E necessario che \Res monitori con grande attenzione il programma di \textit{project management\ped{G}} e che faccia tempestive modifiche alla pianificazione e al rendiconto dei costi;
