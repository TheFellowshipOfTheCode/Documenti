...
Questo documento definisce le norme interne che i membri di \textit{\gruppo} dovranno seguire nello svolgimento del capitolato d'appalto \textit{\progetto}. Ogni membro del gruppo ha l'obbligo di visionare il documento e seguire rigorosamente le norme in esso contenute, al fine di garantire uniformità e coesione nel materiale prodotto e assicurando efficacia ed efficienza al lavoro svolto.
