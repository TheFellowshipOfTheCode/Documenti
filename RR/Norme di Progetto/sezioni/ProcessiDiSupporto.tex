...
\begin{itemize}
  ...
  errori nel codice \texit{CSS\ped{G}}. Verrà installato come modulo per 
  \texit{Node.js\ped{G}};
  \item \texit{\textbf{W3C Markup Validator Service\ped{G}}}: validatore che segnala 
  ...
  \item \texit{\textbf{Complexity-report\ped{G}}}: è un'applicazione che verrà installata come modulo per 
  \texit{Node.js\ped{G}} e serve a misurare metriche riguardanti codice \texit{Javascript\ped{G}}, in particolare:
  \begin{itemize}
    \item \texit{Complessità ciclomatica\ped{G}}: misura la complessità delle classi, dei metodi e delle funzioni del programma;
...
\begin{itemize}
  ...
  sugli script realizzati. Verrà installato come modulo per \texit{Node.js\ped{G}}.
\end{itemize}
