...
La scelta di questo \textit{linguaggio di markup\ped{G}} è stata effettuata per avere uno 
...
\begin{itemize}
  \item \textbf{JSHint\ped{G}}: è uno strumento che aiuta a rilevare possibili 
  errori nel codice Javascript\ped{G}. Verrà installato come modulo per 
  Node.js\ped{G};
  \item \textbf{CSSHint\ped{G}}: è uno strumento che aiuta a rilevare possibili 
  errori nel codice CSS\ped{G}. Verrà installato come modulo per 
  Node.js\ped{G};
  \item \textbf{W3C\ped{G} Markup Validator Service}: validatore che segnala 
  errori di sintassi nel codice \textit{HTML\ped{G}}. L’indirizzo \textit{web\ped{G}} di riferimento è 
  il seguente: \href{validator.w3.org/}{validator.w3.org};
  \item \textbf{Complexity-report}: è un'applicazione che verrà installata come modulo per 
  Node.js\ped{G} e serve a misurare metriche riguardanti codice Javascript\ped{G}, in particolare:
  \begin{itemize}
    \item Complessità ciclomatica\ped{G}: misura la complessità delle classi, dei metodi e delle funzioni
    del programma;
...
\begin{itemize}
  \item \textbf{Google Chrome\ped{G} DevTools}: gli strumenti offerti da \textit{Google 
  Chrome\ped{G}} agli sviluppatori servono a tenere sotto controllo l'utilizzo 
  di CPU e di memoria da parte degli oggetti e funzioni Javascript\ped{G};
  \item \textbf{Karma\ped{G}}: è uno strumento per eseguire test di unità e sarà utilizzato per eseguire test
  sugli script realizzati. Verrò installato come modulo per Node.js\ped{G}.
\end{itemize}
