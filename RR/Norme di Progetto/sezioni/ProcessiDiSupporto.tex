...
\begin{itemize}
  ...
  Node.js\ped{G};
  \item \textbf{W3C Markup Validator Service\ped{G}}: validatore che segnala 
  ...
  \item \textbf{Complexity-report\ped{G}}: è un'applicazione che verrà installata come modulo per 
...
\begin{itemize}
  \item \textbf{Google Chrome DevTools\ped{G}}: gli strumenti offerti da \textit{Google 
  ...
  sugli script realizzati. Verrà installato come modulo per Node.js\ped{G}.
\end{itemize}
