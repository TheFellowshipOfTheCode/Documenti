...
La gestione delle relazioni con i proponenti e con i committenti è affidata al \textit{\RdP}, il quale è tenuto, quando ritiene necessario, ad aggiornare i membri del \textit{team\ped{G}} riguardo le informazioni ottenute. 
...
\item
Persone da informare: il verbale va inviato a tutti i partecipanti della riunione, al \textit{team\ped{G}};
\item
...
\textit{Google Drive\ped{G}} è un servizio di \textit{web storage\ped{G}} utilizzato dal 
...
Gli strumenti software per il \textit{controllo versione\ped{G}} sono ritenuti molto spesso necessari per la maggior parte dei progetti di sviluppo software.
...
scelto per il mantenimento dei dati è \textit{GitHub\ped{G}}. \\La struttura base del \textit{repository\ped{G}}:
\begin{itemize}
  \item
	RR;
	\begin{itemize}
...
due insieme di \textit{task\ped{G}} per ogni documento, definite:
\begin{itemize}
...
Dopo che il \textit{\Ver} ha appurato che il \textit{task\ped{G}} soddisfa i requisiti, e quindi è stato redatto secondo le
...
casi eccezionali, può essere rispostato nei \textit{task\ped{G}} \textsl{da verificare}. Questi casi eccezionali possono essere:
\begin{itemize}
  \item Il \textsl{\RdP} non ha approvato il documento e quindi deve essere 
  rivisto;
  \item Il \textsl{\Ver}, dopo un secondo controllo sui \textit{task\ped{G}} a lui assegnati, 
